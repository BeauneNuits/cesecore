 ...
 * 
 * Based on EJBCA (EjbcaConfiguration) version: EjbcaConfiguration.java 11077 2011-01-07 08:06:11Z anatom
 * 
 * @version $Id$
 */
public final class CesecoreConfiguration {
    ...
    public static final String PERSISTENCE_UNIT = "cesecore";
