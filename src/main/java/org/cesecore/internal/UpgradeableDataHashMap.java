...
public abstract class UpgradeableDataHashMap implements IUpgradeableData, java.io.Serializable {
	 ...
	 */
	public static Map<Object, Object> diffMaps(final Map<Object, Object> oldmap, final Map<Object, Object> newmap) {
		final Map<Object, Object> result = new LinkedHashMap<Object, Object>();
    	for (final Object key : oldmap.keySet()) {
			if (newmap.containsKey(key)) {
				// Check if the value is the same
				final Object value = oldmap.get(key);
				if (value == null) {
